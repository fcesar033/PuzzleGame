...
var instrucciones = ["Utilizar las flechas para mover las piezas", "Ordernar las piezas hasta obtener la imagen objetivo"];
...
function mostrarCartelGanador() {
  alert("Felicidades! Lograste completar el objetivo. GANASTE!!");
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  let temporal = [[,,],[,,],[,,]];
  temporal[filaPos1][columnaPos1] = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = temporal[filaPos1][columnaPos1];
}
